  ...
  Widget build(BuildContext context) {
    return new MaterialApp(
      ...
      title: "kLer So on",
        ...
        children: <Widget>[
          new Card(color:Colors.amberAccent,child: new Padding(padding: const EdgeInsets.all(100.1)),),
          new Card(color:Colors.amberAccent,child: new Padding(padding: const EdgeInsets.all(30.1)),),
          new Card(color:Colors.amberAccent,child: new Padding(padding: const EdgeInsets.all(100.1)),),
          new Text("data"),
          new Text("000"),
