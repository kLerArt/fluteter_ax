       ...
       body: 
        ...
        children: <Widget>[
          ...
          new Text("zzzzzzzzzzzz"),
               ...
               new RaisedButton(onPressed: (){mathod2();}, child: new Text("tte   xt", style: TextStyle(fontSize: 20,color: Colors.greenAccent)),
               color: Colors.deepOrangeAccent, shape: RoundedRectangleBorder(
